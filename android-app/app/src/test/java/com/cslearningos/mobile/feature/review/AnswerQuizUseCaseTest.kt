...
private class FakeReviewLearningDao(
    ...
    override suspend fun getPendingNodeOutbox(limit: Int): List<ReplicationOutboxEntity> = unsupported()
    override suspend fun getPendingQuizOutbox(limit: Int): List<ReplicationOutboxEntity> = unsupported()
    override suspend fun markNodeContentSynced(nodeId: String, localRevision: Long, serverRevision: Long) = unsupported()
    override suspend fun markQuizContentSynced(quizId: String, localRevision: Long, serverRevision: Long) = unsupported()
    override suspend fun deleteOutboxItem(changeId: String) = unsupported()
