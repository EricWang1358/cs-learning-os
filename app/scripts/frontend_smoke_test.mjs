...
await page.getByLabel('LLM Wiki pack').waitFor()
await page.getByLabel('LLM Wiki pack').getByRole('button', { name: 'Export LLM Wiki pack' }).click()
await page.getByText(/LLM Wiki pack written to/).waitFor()
